...
Version Name: v2_maths_car_race_with_lane_obstacles
Author: Jacky
Date: Friday, 2nd May 2025
Purpose/Description: Concept Program 2
Language Used: Python 3.10
Files Required: Images
Known Issues: Obstacle cars now spawn in lanes.
Player car needs to align movement with lane positions for version 3.
Need to add Maths Questions for version 4.
"""
