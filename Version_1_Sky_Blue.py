...
Version Name: Version_1_Sky_Blue
Author: Jacky
Date: Monday, 7th July 2025
Purpose/Description: Colour Scheme - Cornflowerblue and skyblue
...
def main_menu():
    ...
    # Title
    tk.Label(root, text="Maths Car Game", font=("SegoeUI", 24, "bold"), bg="skyblue").pack(pady=10)
...
def show_end_screen():
    ...
    tk.Label(end_root, text="You Crashed!", font=("SegoeUI", 24, "bold"), bg="skyblue").pack(pady=10)
