...
Version Name: Version_4_Cyan_Red
Author: Jacky
Date: Monday, 7th July 2025
Purpose/Description: Colour Scheme - Cyan and Red
...
def main_menu():
    ...
    logo_label = tk.Label(root, image=logo_img, bg="cyan")
    logo_label.image = logo_img  
    logo_label.pack(pady=(3,3))

    # Title
    tk.Label(root, text="Maths Car Game", font=("SegoeUI", 24, "bold"), bg="cyan").pack(pady=10)
...
def start_clicked():
    ...
    tk.Label(root, text="Enter Username", font=("SegoeUI", 20), bg="cyan").pack(pady=10)

    username_frame = tk.Frame(root, bg="cyan")
    username_frame.pack(pady=5)

    tk.Label(username_frame, text="Username:", font=("SegoeUI", 14), bg="cyan").pack(side=tk.LEFT)
...
def show_leaderboard_screen():
    ...
    leaderboard_window.configure(bg="red")
...
def show_mistakes_screen():
    ...
    mistakes_window.configure(bg="red")
...
def show_difficulty_screen():
    ...
    difficulty_window.configure(bg="cyan")
...
def show_end_screen():
    ...
    end_root.configure(bg="cyan")
    end_root.resizable(False, False)

    # Load logo image
    logo_img = tk.PhotoImage(file="logo.png")
    logo_label = tk.Label(end_root, image=logo_img, bg="cyan")
    logo_label.image = logo_img  
    logo_label.pack(pady=(3,3))

    tk.Label(end_root, text="You Crashed!", font=("SegoeUI", 24, "bold"), bg="cyan").pack(pady=10)
    ...
    tk.Label(end_root, text=f"Average Answer Time: {avg_answer_time:.2f} seconds", font=("SegoeUI", 16), bg="cyan").pack(pady=10)
    tk.Label(end_root, text=time_text, font=("SegoeUI", 16), bg="cyan").pack(pady=10)
