...
Version Name: v9_trial_program_new_restart
Author: Jacky
...
Known Issues: 
Fixed Issues: Restart screen now boots back to the start screen.
"""
...
def main_menu():
    ...
    # Title
    tk.Label(root, text="Maths Car Game", font=("SegoeUI", 24, "bold"), bg="skyblue").pack(pady=30)
