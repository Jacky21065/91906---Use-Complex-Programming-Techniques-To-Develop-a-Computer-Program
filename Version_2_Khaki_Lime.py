...
Version Name: Version_2_Khaki_Lime
Author: Jacky
Date: Monday, 7th July 2025
Purpose/Description: Colour Scheme - Khaki and Lime
...
def main_menu():
    ...
    logo_label = tk.Label(root, image=logo_img, bg="khaki")
    logo_label.image = logo_img  
    logo_label.pack(pady=(3,3))

    # Title
    tk.Label(root, text="Maths Car Game", font=("SegoeUI", 24, "bold"), bg="khaki").pack(pady=10)

    # Buttons frame
    btn_frame = tk.Frame(root, bg="khaki")
...
def start_clicked():
    ...
    tk.Label(root, text="Enter Username", font=("SegoeUI", 20), bg="khaki").pack(pady=10)

    username_frame = tk.Frame(root, bg="khaki")
    username_frame.pack(pady=5)

    tk.Label(username_frame, text="Username:", font=("SegoeUI", 14), bg="khaki").pack(side=tk.LEFT)
...
def show_leaderboard_screen():
    ...
    leaderboard_window.configure(bg="lime")
...
def show_mistakes_screen():
    ...
    mistakes_window.configure(bg="lime")
...
def show_difficulty_screen():
    ...
    difficulty_window.configure(bg="khaki")
...
def show_end_screen():
    ...
    end_root.configure(bg="khaki")
    end_root.resizable(False, False)

    # Load logo image
    logo_img = tk.PhotoImage(file="logo.png")
    logo_label = tk.Label(end_root, image=logo_img, bg="khaki")
    logo_label.image = logo_img  
    logo_label.pack(pady=(3,3))

    tk.Label(end_root, text="You Crashed!", font=("SegoeUI", 24, "bold"), bg="khaki").pack(pady=10)
    ...
    tk.Label(end_root, text=f"Average Answer Time: {avg_answer_time:.2f} seconds", font=("SegoeUI", 16), bg="khaki").pack(pady=10)
    tk.Label(end_root, text=time_text, font=("SegoeUI", 16), bg="khaki").pack(pady=10)
