...
Version Name: v1_maths_car_race_with_Tkinter
Author: Jacky
Date: Friday, 30th May 2025
Purpose/Description: Development Program 1
Language Used: Python 3.10
Files Required: Images, Music
Known Issues: Need to add a range of diffculty levels and their corresponding maths questions.
"""
...
def gameloop():
    ...
    while not gameExit:
        ...
        car_x = lane1_x if car_lane == 1 else lane2_x
...
You are the blue player car.

Keys: Use the left and right arrow keys to move the blue player car across the lanes.
Hold SPACE to boost speed.

Answer the math questions by driving into the red car with the correct answer.""")
