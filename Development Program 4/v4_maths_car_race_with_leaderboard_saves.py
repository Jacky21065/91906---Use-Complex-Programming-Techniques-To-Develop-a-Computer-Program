...
Version Name: v4_maths_car_race_with_leaderboard_saves
Author: 
...
Fixed Issues: Functionality of the leaderboard, which is being saved to a text file.
Fixed Issues: Recorded time now includes the average answer time per question and all data is being
saved to a textfile and also on the leaderboard.
"""
...
def show_leaderboard_screen():
    ...
    leaderboard_window.geometry("650x450")
    ...
    # Header
    header = f"{'Username':<15} {'Score':<7} {'Total Time (s)':<18} {'Avg Time (s)':<15}"
