...
Version Name: v5_maths_car_race_with_difficulties
Author: 
Date: Sunday, 17th June 2025
Purpose/Description: Development Program 5
Language Used: Python 3.10
Files Required: Images, Music
Known Issues: 
Fixed Issues: Added a range of difficulty levels and their corresponding maths questions.
Fixed Issues: Added an import of the sympy library
"""
