...
Version Name: Music_2
Author: Jacky
Date: Wednesday, 9th July 2025
Purpose/Description: Music_2
...
def setup_pygame():
    ...
    try:
        ...
        START_MUSIC = pygame.mixer.Sound("option2.mp3")
...
def main_menu():
    ...
    # Title
    tk.Label(root, text="Maths Car Game", font=("Comic Sans MS", 24, "bold"), bg="skyblue").pack(pady=10)
...
def show_end_screen():
    ...
    tk.Label(end_root, text="You Crashed!", font=("Comic Sans MS", 24, "bold"), bg="skyblue").pack(pady=10)
