...
Version Name: Version_1_Comic_Sans_MS
Author: Jacky
Date: Tuesday, 8th July 2025
Purpose/Description: Font - Comic Sans MS
...
def main_menu():
    ...
    # Title
    tk.Label(root, text="Maths Car Game", font=("Comic Sans MS", 24, "bold"), bg="skyblue").pack(pady=2)

    # Buttons frame
    btn_frame = tk.Frame(root, bg="skyblue")
    btn_frame.pack(pady=30)

    tk.Button(btn_frame, text="Start", font=("Comic Sans MS", 14), width=16, command=start_clicked).pack(pady=10)
    tk.Button(btn_frame, text="Instructions", font=("Comic Sans MS", 14), width=16, command=show_instructions).pack(pady=10)
    tk.Button(btn_frame, text="Leaderboard", font=("Comic Sans MS", 14), width=16, command=show_leaderboard_screen).pack(pady=10)
    tk.Button(btn_frame, text="Mistakes", font=("Comic Sans MS", 14), width=16, command=show_mistakes_screen).pack(pady=10)
    tk.Button(btn_frame, text="Exit", font=("Comic Sans MS", 14), width=16, command=root.destroy).pack(pady=10)
...
def start_clicked():
    ...
    tk.Label(root, text="Enter Username", font=("Comic Sans MS", 20), bg="skyblue").pack(pady=10)

    username_frame = tk.Frame(root, bg="skyblue")
    username_frame.pack(pady=5)

    tk.Label(username_frame, text="Username:", font=("Comic Sans MS", 14), bg="skyblue").pack(side=tk.LEFT)
    global username_entry
    username_entry = tk.Entry(username_frame, font=("Comic Sans MS", 14))
    username_entry.pack(side=tk.LEFT)

    tk.Button(root, text="Continue", font=("Comic Sans MS", 12), command=launch_game).pack(pady=10)
...
def show_leaderboard_screen():
    ...
    # Title
    tk.Label(leaderboard_window, text="Leaderboard - Top 10", font=("Comic Sans MS", 18, "bold"), bg="white").pack(pady=10)
...
def show_mistakes_screen():
    ...
    tk.Label(mistakes_window, text="Mistakes Log", font=("Comic Sans MS", 18, "bold"), bg="white").pack(pady=10)
...
def show_difficulty_screen():
    ...
    tk.Label(difficulty_window, text="Choose Difficulty:", font=("Comic Sans MS", 18, "bold"), bg="white").pack(pady=20)

    # Create buttons for each difficulty level
    difficulties = ["Beginner", "Easy", "Medium", "Hard", "Advanced"]
    for diff in difficulties:
        tk.Button(difficulty_window, text=diff, font=("Comic Sans MS", 14),
                  width=20, pady=10, bg="#e0e0e0", command=lambda d=diff: start_game_with_difficulty(d, difficulty_window)).pack(pady=2)
...
def show_end_screen():
    ...
    tk.Label(end_root, text="You Crashed!", font=("Comic Sans MS", 24, "bold"), bg="skyblue").pack(pady=2)
    ...
    tk.Label(end_root, text=f"Average Answer Time: {avg_answer_time:.2f} seconds", font=("Comic Sans MS", 16), bg="skyblue").pack(pady=10)
    tk.Label(end_root, text=time_text, font=("Comic Sans MS", 16), bg="skyblue").pack(pady=10)
    ...
    # Buttons
    tk.Button(end_root, text="Restart", font=("Comic Sans MS", 16), width=15, command=restart_game).pack(pady=10)
    tk.Button(end_root, text="Mistakes", font=("Comic Sans MS", 16), width=15, command=show_mistakes_screen).pack(pady=10)
    tk.Button(end_root, text="Leaderboard", font=("Comic Sans MS", 16), width=15, command=show_leaderboard_screen).pack(pady=10)
    tk.Button(end_root, text="Quit", font=("Comic Sans MS", 16), width=15, command=quit_game).pack(pady=10)
