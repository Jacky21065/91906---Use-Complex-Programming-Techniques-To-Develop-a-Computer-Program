...
Version Name: Version_3_Numbers_+Apple
Author: Jacky
Date: Tuesday, 15th July 2025
Purpose/Description: Numbers Logo + Apple Logo Combination
...
def main_menu():
    ...
    # Load logo image
    logo_img = tk.PhotoImage(file="option1.png")
    logo_label = tk.Label(root, image=logo_img, bg="skyblue")
    logo_label.image = logo_img  
    logo_label.pack(pady=(3,3))

    # Title
    tk.Label(root, text="Maths Car Game", font=("Times New Roman", 24, "bold"), bg="skyblue").pack(pady=10)

    # Buttons frame
    btn_frame = tk.Frame(root, bg="skyblue")
    btn_frame.pack(pady=30)

    tk.Button(btn_frame, text="Start", font=("Times New Roman", 14), width=16, command=start_clicked).pack(pady=10)
    tk.Button(btn_frame, text="Instructions", font=("Times New Roman", 14), width=16, command=show_instructions).pack(pady=10)
    tk.Button(btn_frame, text="Leaderboard", font=("Times New Roman", 14), width=16, command=show_leaderboard_screen).pack(pady=10)
    tk.Button(btn_frame, text="Mistakes", font=("Times New Roman", 14), width=16, command=show_mistakes_screen).pack(pady=10)
    tk.Button(btn_frame, text="Exit", font=("Times New Roman", 14), width=16, command=root.destroy).pack(pady=10)
...
def start_clicked():
    ...
    tk.Label(root, text="Enter Username", font=("Times New Roman", 20), bg="skyblue").pack(pady=10)

    username_frame = tk.Frame(root, bg="skyblue")
    username_frame.pack(pady=5)

    tk.Label(username_frame, text="Username:", font=("Times New Roman", 14), bg="skyblue").pack(side=tk.LEFT)
    global username_entry
    username_entry = tk.Entry(username_frame, font=("Times New Roman", 14))
    username_entry.pack(side=tk.LEFT)

    tk.Button(root, text="Continue", font=("Times New Roman", 12), command=launch_game).pack(pady=10)
...
def show_leaderboard_screen():
    ...
    # Title
    tk.Label(leaderboard_window, text="Leaderboard - Top 10", font=("Times New Roman", 18, "bold"), bg="white").pack(pady=10)
...
def show_mistakes_screen():
    ...
    tk.Label(mistakes_window, text="Mistakes Log", font=("Times New Roman", 18, "bold"), bg="white").pack(pady=10)
...
def show_difficulty_screen():
    ...
    tk.Label(difficulty_window, text="Choose Difficulty:", font=("Times New Roman", 18, "bold"), bg="white").pack(pady=20)

    # Create buttons for each difficulty level
    difficulties = ["Beginner", "Easy", "Medium", "Hard", "Advanced"]
    for diff in difficulties:
        tk.Button(difficulty_window, text=diff, font=("Times New Roman", 14),
...
def show_end_screen():
    ...
    # Load logo image
    logo_img = tk.PhotoImage(file="option3.png")
    logo_label = tk.Label(end_root, image=logo_img, bg="skyblue")
    logo_label.image = logo_img  
    logo_label.pack(pady=(3,3))

    tk.Label(end_root, text="You Crashed!", font=("Times New Roman", 24, "bold"), bg="skyblue").pack(pady=10)
    ...
    tk.Label(end_root, text=f"Average Answer Time: {avg_answer_time:.2f} seconds", font=("Times New Roman", 16), bg="skyblue").pack(pady=10)
    tk.Label(end_root, text=time_text, font=("Times New Roman", 16), bg="skyblue").pack(pady=10)
    ...
    # Buttons
    tk.Button(end_root, text="Restart", font=("Times New Roman", 16), width=15, command=restart_game).pack(pady=10)
    tk.Button(end_root, text="Mistakes", font=("Times New Roman", 16), width=15, command=show_mistakes_screen).pack(pady=10)
    tk.Button(end_root, text="Leaderboard", font=("Times New Roman", 16), width=15, command=show_leaderboard_screen).pack(pady=10)
    tk.Button(end_root, text="Quit", font=("Times New Roman", 16), width=15, command=quit_game).pack(pady=10)
